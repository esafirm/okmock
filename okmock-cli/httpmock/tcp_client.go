...
func Connect(mockContexts []MockContext) {
	var rawStrings []string
	for _, context := range mockContexts {
		rawStrings = append(rawStrings, context.Raw)
	}
	...
	for {
		...
		write(connection, createMockPayload(rawStrings))
